...
public class DocumentTypeController : ControllerBase
{
	...
	[HttpPost]
	public async Task<IActionResult> Create(DocumentTypeCreateDto dto)
	{
		var createdBy = Guid.Empty; // Replace with JWT user ID
	...
	[HttpPut("{id:guid}")]
	public async Task<IActionResult> Update(Guid id, DocumentTypeUpdateDto dto)
	{

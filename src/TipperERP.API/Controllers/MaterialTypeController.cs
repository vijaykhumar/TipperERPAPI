...
public class MaterialTypeController : ControllerBase
{
	...
	[HttpPost]
	public async Task<IActionResult> Create(MaterialTypeCreateDto dto)
	{
		var createdBy = Guid.Empty; // TODO extract from JWT later
	...
	[HttpPut("{id:guid}")]
	public async Task<IActionResult> Update(Guid id, MaterialTypeUpdateDto dto)
	{

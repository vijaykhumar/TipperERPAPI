...
{
	private readonly ILoanEmiService _service;

	public LoanEmiController(ILoanEmiService service)
	{
		_service = service;
	}
	...
	[HttpPost]
	public async Task<IActionResult> Create(LoanEmiCreateDto dto)
	{
		var createdBy = Guid.Empty; // To be replaced with JWT User
	...
	[HttpPut("{id:guid}")]
	public async Task<IActionResult> Update(Guid id, LoanEmiUpdateDto dto)
	{

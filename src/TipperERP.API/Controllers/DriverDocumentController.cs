...
{
	private readonly IDriverDocumentService _service;

	public DriverDocumentController(IDriverDocumentService service)
	{
		_service = service;
	}
	...
	[HttpPost]
	public async Task<IActionResult> Create(DriverDocumentCreateDto dto)
	{
		var createdBy = Guid.Empty; // Replace with JWT user
	...
	[HttpPut("{id:guid}")]
	public async Task<IActionResult> Update(Guid id, DriverDocumentUpdateDto dto)
	{
